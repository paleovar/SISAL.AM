...
wd <- '~/Documents/R Package/' #choose a directory to work in

eID <- SISAL.AM::filter_SISAL(1) %>%
  filter(entity_id < 5) # run a selection of records of class 1
